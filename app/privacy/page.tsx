    ...
    <SiteShell>
      <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
        ...
        <section className="mt-8 space-y-3">
          <h2 className="text-lg font-semibold tracking-tight">Operator</h2>
          <p className="text-sm text-muted-foreground">
            This hosted instance runs on Vercel (or your own deployment). Server
            logs may be retained by the hosting provider according to their
            policies. No analytics or advertising scripts are loaded in the app.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            httpOnly session cookie. It is never exposed to client-side
            JavaScript and is never written to Redis or any other external
            store.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            deduplication locks (max 90 seconds), which contain only an
            anonymized user identifier. Your GitHub access token is never
            written to Redis.
          </p>
          <p className="text-sm text-muted-foreground">
            Scan preferences (branch names, filters) may be stored in your
            browser localStorage and in the page URL for convenience. They do
            not include secrets.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            identifier, scan parameters (branch names, repo count), and GitHub
            API error or rate-limit events. Tokens and authorization headers are
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            GitHub&apos;s API. No analytics, advertising, or tracking scripts
            are loaded.
          </p>
        </section>
        ...
        <section className="mt-8 space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            . Revoking access immediately invalidates your token. Any
            temporarily cached scan data expires automatically within 2 minutes.
          </p>
        </section>
      </main>
    </SiteShell>
